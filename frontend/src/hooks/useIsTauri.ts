...
// (see titleBarStyle: "Overlay" in src-tauri/tauri.conf.json) - Windows and
// Linux keep their native decorated title bar, so title-bar-specific layout
// adjustments must not apply there.
