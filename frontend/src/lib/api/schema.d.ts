...
export interface paths {
    ...
    "/api/user/steam/wishlist/preview": {
        ...
        get: operations["ApiUserSteamWishlistPreviewPreviewSteamWishlist"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/user/steam/wishlist/import/stream": {
        ...
        post: operations["ApiUserSteamWishlistImportStreamImportSteamWishlistStream"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/user/steam/library/preview/stream": {
        ...
        post: operations["ApiUserSteamLibraryPreviewStreamPreviewSteamLibraryStream"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface operations {
    ...
    ApiUserSteamImportStreamImportSteamLibraryStream: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["SteamWishlistItem"][] | null;
            };
        };
        responses: {
            /** @description Request fulfilled, document follows */
    ...
    ApiUserSteamWishlistPreviewPreviewSteamWishlist: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["SteamPreviewItem"][];
                };
            };
        };
    };
    ApiUserSteamWishlistImportStreamImportSteamWishlistStream: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["SteamWishlistItem"][];
            };
        };
        responses: {
            /** @description Request fulfilled, document follows */
    ...
    ApiUserSteamLibraryPreviewStreamPreviewSteamLibraryStream: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
