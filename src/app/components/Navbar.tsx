    ...
    return (
        <div className="mt-1 flex flex-row items-center min-w-screen">
            ...
            <div className="flex justify-center items-center flex-1 max-w-screen-lg">
                ...
                >
                    <div className="">
                        <Button className="w-28" content="home" link="http://localhost:3000"/>
                    </div>
                    <div className="">
                        <Button className="w-28" content="manager" link="http://localhost:3000/manager"/>
                    </div>
                    <div className="">
                        <Button className="w-28" content="import" link="http://localhost:3000/import"/>
                    </div>
                </div>
            </div>
            <div className="flex justify-end flex-1 pr-5">
                <Button className="w-14 h-14" content={icons.at(0)} link={"http://localhost/auth/login"}/>
            </div>
        </div>
    );
};
