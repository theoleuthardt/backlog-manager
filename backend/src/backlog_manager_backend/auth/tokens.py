...
# Distinguishes a real access token from a 2FA challenge token (issued once
# the password check passes, before the second factor is checked) - without
# this, a challenge token would decode successfully anywhere an access
# token is accepted, bypassing 2FA entirely.
